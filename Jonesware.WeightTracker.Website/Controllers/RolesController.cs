using Jonesware.WeightTracker.Website.ApiModels.Roles;
using Jonesware.WeightTracker.Website.BindingModels.Roles;
...
namespace Jonesware.WeightTracker.Website.Controllers
{
	...
	public class RolesController : BaseApiController
	{
		...
		public async Task<IHttpActionResult> GetRole(string Id)
		{
			...
			if (role != null)
			{
				return Ok(CreateRoleApiModel(role));
			}
		...
		public async Task<IHttpActionResult> Create(CreateRoleBindingModel model)
		{
			...
			return Created(locationHeader, CreateRoleApiModel(role));
		}
		...
		private RoleApiModel CreateRoleApiModel(IdentityRole appRole)
		{
			var model = new RoleApiModel
			{
				Url = Url.Link("GetRoleById", new { id = appRole.Id }),
				Id = appRole.Id,
				Name = appRole.Name
			};
